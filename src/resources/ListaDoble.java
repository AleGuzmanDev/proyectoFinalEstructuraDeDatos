...
public class ListaDoble<T> implements Iterable<T> {
    ...
    public void insertarEnPosicion(T dato, int posicion) {
        ...
        if (nodoPrimero == null) {
            ...
            // Insertar al final o en una posición mayor o igual al tamaño
            nuevoNodo.setAnteriorNodo(nodoUltimo);
            nodoUltimo.setSiguienteNodo(nuevoNodo);
            nodoUltimo = nuevoNodo;
        } else {
            ...
            nuevoNodo.setAnteriorNodo(nodoActual);
            nodoActual.getSiguienteNodo().setAnteriorNodo(nuevoNodo);
    ...
    public T eliminarUltimo() {
        ...
        if( !estaVacia() ) {
            ...
            NodoDoble<T> prev = obtenerNodo(tamano-2);
            nodoUltimo = prev;
    ...
    public void imprimiendoHaciaAtras() {
        NodoDoble<T> nodoActual = nodoUltimo; // Comenzamos desde el último nodo

        while (nodoActual != null) {
            System.out.print(nodoActual.getValorNodo() + " "); // Imprimir el valor del nodo
            nodoActual = nodoActual.getAnteriorNodo(); // Mover al nodo anterior
        }

        System.out.println(); // Nueva línea al final para un formato adecuado
    }
